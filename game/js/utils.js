/*
	This file is the physics engine for our game, based off of a tutorial from EaselJS
*/
...
function calculateCollision(obj, direction, collideables, moveBy)
{
    ...
    // of the scribe's future position's bounding-rectangle
    while ( !collision && cc < collideables.length ) {
      ...
      if ( !collision && collideables[cc].isVisible ) {
        ...
        // the scribe got onto the "other side" of an object (high velocity e.g.),
        // then we will detect this here, and adjust the velocity according to
        // it to prevent the Scribe from "ghosting" through objects
